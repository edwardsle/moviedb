...
declare class MDBDatePickerV5 extends Component<
  {
    adornmentPosition?: string;
    allowKeyboardControl?: boolean;
    animateYearScrolling?: boolean;
...
declare class MDBExportToCSV$1 extends Component<
  {
    active?: boolean,
    block?: boolean,
    columns: object[],
...
declare class MDBSelectV5 extends Component<
  {
    children?: ReactNode;
    className?: string;
    color?: string;
...
declare const MDBSelectOptionV5: FunctionComponent<{
  checked?: boolean;
  disabled?: boolean;
  focusShadow?: string;
  focusBackgroundColor?: string;
...
declare const MDBSelectOptionsV5: FunctionComponent<{
  allChecked?: boolean;
  changeFocus?: () => void;
  focused?: number;
  focusShadow?: string;
...
declare const MDBSideNavItem$1: FunctionComponent<{
  className?: string;
  children?: ReactNode;
  innerRef?: ((innerRef: RefObject<HTMLElement>) => void) | RefObject<HTMLElement> | string | null;
  href?: string;
...
declare class MDBSideNavLink$1 extends Component<{
  children?: ReactNode;
  className?: string;
  disabled?: boolean;
  href?: string;
...
declare class MDBSideNavNav$1 extends Component<
  {
    children?: ReactNode;
    className?: string;
    tag?: string;
